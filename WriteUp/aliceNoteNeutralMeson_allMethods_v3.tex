...
\addTODOpointer{PCMEMCal}{cyan!80!black}
% \addTODOpointer{PCMPHOS}{red}
\addTODOpointer{PCM}{violet}
\addTODOpointer{PHOS}{green!60!black}
...
\include{PhotonDetection_PCM_v1}
\include{PhotonDetection_EDC_v1}
\include{PhotonDetection_PHOS_v1}
\include{PhotonDetection_hybrids_v1}
